      ...
      <div className="marketing-container whitepaper-body">
        ...
        <main className="whitepaper-content">
          ...
          <section id="about-openflow" className="whitepaper-section">
            ...
            <p>
              OpenFlow is building the infrastructure layer where trust enables value — systems that let businesses,
              protocols, and communities verify genuine participation before exchanging value with it.
            </p>
          </section>
          ...
          <section id="about-openflow-labs" className="whitepaper-section">
            ...
            <p>
              OTI is the first product out of OpenFlow Labs, but not the last. The roadmap extends to developer
              tools, trust services, reputation systems, and infrastructure for decentralized participation — all
          ...
          <section id="the-problem" className="whitepaper-section">
            ...
            <p>
              Attention has become one of the most valuable assets on the internet. The problem: there is no open
              infrastructure to verify it.
            </p>
            <p>
          ...
          <section id="distribution" className="whitepaper-section">
            ...
            <p>OTI is designed to distribute itself. Four channels are planned for post-MVP launch, each requiring zero setup from the integrating developer:</p>
            <p>
          ...
          <section id="revenue-model" className="whitepaper-section">
            ...
            <p>OTI runs a tiered API model. Community users get free access; as usage grows, the path to paying plans is direct.</p>
            <RevenueTable />
            <p>
          ...
          <section id="openflow-vision" className="whitepaper-section">
            ...
            <p>
              The internet is moving toward an attention economy. OTI is built on the premise that attention
              cannot become valuable until it becomes verifiable.
            </p>
            <p>OTI is the foundation of a larger vision: <strong>the OpenFlow Attention Economy</strong>.</p>
            <p>
              The OpenFlow Attention Economy treats verified participation as an asset — something that can be
              measured, priced, and exchanged — rather than scraped as advertising inventory. Trust is the
              prerequisite. OTI provides it.
            </p>
            <p>Two models support this:</p>
            <p>
          ...
          <section id="team" className="whitepaper-section">
            ...
            <p>
              Ahmad Alhassan is a technology entrepreneur and systems designer from Nigeria. He leads the vision,
              product strategy, and economic design behind OpenFlow and OTI — building the infrastructure layer
              for trust and verified attention in Web3.
            </p>
            <h3>Mustapha Abdullahi (Musty)</h3>
            <p><em>Co-Founder</em></p>
            <p>
              Mustapha is a co-founder of OpenFlow. He works alongside Ahmad on the long-term vision and
