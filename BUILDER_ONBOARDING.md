...
- The design language: deep blue-black background (`#05080f`), mint green (`#00e5a0`) as accent, monospace typography — see the locked color token table in `FRONTEND_TASKS.md` for the full palette
